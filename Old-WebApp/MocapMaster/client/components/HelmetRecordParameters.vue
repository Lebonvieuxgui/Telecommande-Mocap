    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <el-row class="record-controls">
          <el-row>
            <el-col :xs="24" :sm="8">
              <div class="record-controls-label">File name</div>
            </el-col>
            <el-col :xs="24" :sm="16">
          ...
          <el-row>
            <el-col :xs="24" :sm="8">
              <div class="record-controls-label">Duration</div>
            </el-col>
            <el-col :xs="24" :sm="16">
              <div class="record-controls-value">
                {{ displayedDuration }}
...
export default {
  ...
  computed: {
    ...
    filename: function () {
      ...
      return (this.globalFilename + (this.devices.length === 1 ? "_" + this.devices[0].helmetName : "_HELMETNAME"));
    }
  },
  methods: {
